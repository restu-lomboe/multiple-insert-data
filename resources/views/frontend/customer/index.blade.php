    ...
    <div class="container">
        ...
        <form class="mt-5" action=" {{ route('store.customer') }} " method="POST">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="emal" class="form-control" name="email" value="{{ old('email') }}"
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="kode_pos[]" value="{{ old('kode_pos') }}"
                        placeholder="Masukan kode pos kamu" required>
                </div>
            </div>
            <div class="form-group row">
                <label class="col-sm-2 col-form-label"></label>
                <div class="col-sm-10">
                    <a href="#" class="addcustomer btn btn-primary" style="float: right;">Tambah Alamat</a>
                </div>
            </div>
